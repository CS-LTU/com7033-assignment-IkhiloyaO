...
from .Mongodb_User import MongoUser
from .Mongodb_Patients import MongoPatients
...
def add_patient():
    ...
    if form.validate_on_submit():
        ...
        #INSERT INTO MONGODB
        # try:
        #     MongoPatients.validate({"first_name":first_name,"last_name":last_name,"middle_name":middle_name,
        #                             "phone_number":phone_number,"address":address,
        #                             "gender": gender, "age":age, "hypertension":hypertension, "ever_married":ever_married,
        #                             "work_type": work_type,"residence_type":residence_type,
        #                             "avg_glucose_level":avg_glucose_level, "bmi":bmi,
        #                             "smoking status":smoking_status,"stroke":stroke
        #                             })
        #     mongopatients = MongoPatients(first_name,last_name,middle_name,phone_number,address,gender,
        #                                   age,hypertension,ever_married,work_type,residence_type,
        ...
        patients = Patient(first_name=first_name, last_name=last_name, middle_name=middle_name,
                           phone_number=phone_number, address=address, gender=gender, age=age,
                           hypertension=hypertension, ever_married=ever_married, work_type=work_type,
...
def register():
    ...
    if form.validate_on_submit():
        ...
        # try:
        #
        #    MongoUser.validate({"first_name": first_name,"last_name": last_name, "email": email,"password": password})
        #    user = MongoUser(first_name, last_name, email, password)
        #    user.save()
